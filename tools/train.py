...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--adaptive_scale', action='store_true', help='resize images using adaptive scaling (maintain aspect ratio)')
    parser.add_argument('--adaptive_long-side', type=int, default=640, choices=[320, 416, 480, 640, 800, 960, 1000, 1024, 1280], help='target long-side dimension: 320/416/480/640/800/960/1000/1024/1280')
    parser.add_argument('--adaptive_quality', type=int, default=95, help='JPEG quality for adaptive scaling (1-100)')
